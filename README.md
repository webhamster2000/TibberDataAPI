...
What it does
First run: opens your browser for Tibber login, catches the OAuth callback automatically on port 17235, exchanges the code for tokens, and saves them to ~/.tibber_tokens.json (mode 600).
